...
% \input{tables/all-dashboards}
% \input{tables/all-dashboards-brief}
...
% The focus group work by \cite{abuzour2023dynairx} has identified items that include and emphasise the need for a timeline to present visual summaries of the combined patient record. The focus group participants have identified the need to visualise changes over time and prescription timelines, among others.
...
% \input{tables/ehr-star}
% \input{tables/ehr-star-brief}
